...
export function Video(props) {
  const { data } = useQuery(GET_LESSONS_BY_SLUG, {
    variables: {
    ...
    <div className="flex-1">
      <div className="bg-black flex justify-center">
        <div className="h-full w-full max-w-[1100px] max-h-[60vh] aspect-video">
          <Player>
            {/* <Youtube videoId={data.lesson} /> */}
            <DefaultUi />
          </Player>
        </div>
      </div>

      <div className="p-8 nax-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/CristianoLagesf.png"
                alt="github"
              />
          ...
          <div className="flex flex-col gap-4">
            <a href="#"
              className="p-4 text-sm bg-green-500 
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          ...
          >
            <div className="bg-green-700 h-full p-6 fle items-center">
